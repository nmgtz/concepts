function createOptionElement() {
    ...
    if (subClasses === "Form One") {
        ...
        var mainOptions = [
            ...
            { value: "explain the meaning of life skills and apply them in their lives"},
...
topicLesson.appendChild(opt);
        ...
        { value: "Describes the importance and functions of liturature"},
        { value: "identify forms and genres of literature"},
        { value: "describe the form and content of pieces of literary works"},
        { value: "analyse literary devices"},
        { value: "compose simple literary works"},
        { value: "explain the relationship between language and literature"},
        
        ];
        
        var competenceOptions = [
        { value: "Select Competence"},
        { value: "using literary terms appropriately"},
        { value: "analysing the importance and functions of literature"},
        { value: "analysing the functions of language in literature"},
        { value: "describing form and content of oral and written literature"},
        { value: "appreciating/analsing literary works"},
        { value: "applying literary devices in creative writing"},
        
        ];
        
        var referenceOptions = [
        { value: "Select Reference"},
        { value: "tie (2022),literature for secondary schools student's book form three"},
        
        ];
        var topicsOptions = [
        { value: "Select Topic"},
        { value: "introduction to literature"},
        { value: "oral literature"},
        { value: "written literature"},
        { value: "apprecciating and analysing of plays"},
        ];
...
topicLesson.appendChild(opt);
        ...
        var mainOptions = [
        { value: "Select Main Objective"},
        { value: "understand the setting,plot,style and language of literary work"},
        { value: "describe characters and characterisation in literary work"},
        { value: "assess the relevancce of the text in the contemporary society"},
        { value: "use literary devices in composing literary works and dramatising play"},
        { value: "makes review of pieces of literary works"},
        ];
        
        var competenceOptions = [
        { value: "Select Competence"},
        { value: "appreciating,literary works(plays,novovels,poems and short stories"},
        { value: "analysing the title,setting,characters,style and language use in literary works"},
        { value: "comprehending issues and their related implications(message and lessons"},
        { value: "making critiques of pieces of literary works"},
        { value: "writing simple piece of literary works in specified genres"},
        { value: "narrating a piece of work and performing it on stage"},
        
        ];
        
        var referenceOptions = [
        { value: "Select Reference"},
        { value: "tie (2022),literature for secondary schools student's book form four"},
        
        ];
        var topicsOptions = [
        { value: "Select Topic"},
        { value: "novels and short stories"},
        { value: "appreciating and analysing poetry"},
        ];
